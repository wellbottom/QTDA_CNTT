...
export const testimonials = [
    ...
    { id: 5, name: "Isabella Rossi", address: "Rome, Italy", image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=200", rating: 4, review: "QuickStay has transformed how I travel. The interface is intuitive, and the selection of properties is outstanding." },
    { id: 6, name: "Oliver Schmidt", address: "Berlin, Germany", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=200", rating: 5, review: "Best booking platform I've ever used. The exclusive deals and personalized recommendations are worth every penny!" },
    { id: 7, name: "Aisha Patel", address: "Mumbai, India", image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=200", rating: 5, review: "I travel frequently for work, and QuickStay makes it so easy to find quality accommodations quickly. Couldn't be happier!" },
    { id: 8, name: "James Mitchell", address: "London, UK", image: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=200", rating: 4, review: "The platform is reliable and the booking process is straightforward. Great value for money and excellent customer support." }
];
// Facility Icon
